...
Coloque o ZIP ao lado dos arquivos-fonte com o nome `Traducao-PTBR-The-Survey-v1.1.zip` e execute:
...
& $csc /nologo /target:winexe /optimize+ /win32manifest:app.manifest `
  ...
  /resource:Traducao-PTBR-The-Survey-v1.1.zip,TranslationPayload `
  /out:Traducao-PTBR-The-Survey-Instalador-v1.1.exe Installer.cs
```
